...
export function ServicesDesktop() {
    return (
        <section className="hidden w-full bg-bg-default py-16 lg:block">
            <Container className="flex flex-col items-center justify-center gap-16">
                {/* Header */}
                <div className="flex w-[659px] flex-col items-center justify-start gap-3 text-center">
                    <h2 className="text-[60px] font-medium leading-[64px] text-text-heading">
                        Our <span className="text-primary">Services & Products</span>
                    </h2>
                    <p className="w-[590px] text-base font-normal leading-4 text-text-body">
